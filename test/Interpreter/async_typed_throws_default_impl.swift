...
//
// Regression guard for the async typed-throws [ind_error, swiftself] reorder
// (#89320 / PR #89715): a generic rethrows short-circuit algorithm draining an
// iterator whose next(isolation:) is the AsyncIteratorProtocol default impl
// dropped/corrupted the upstream error on Linux. The RED is observable only on
// Linux (x86_64 swallow, arm64 crash); on Darwin this passes regardless, which
// is expected — the regression is Linux-specific.
