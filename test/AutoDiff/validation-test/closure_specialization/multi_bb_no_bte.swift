...
AutoDiffClosureSpecMultiBBNoBTETests.testWithLeakChecking("Test3") {
  ...
  // CHECK3:       sil private @$s3outyycfU1_8multiplyL_ySfAAyycfU1_20RealPropertyWrappersL_VFTJpSpSr015$s3outyycfU1_20cdE16L_V1xSfvgTJpSpSr073$sSf16_DifferentiationE12_vjpMultiply3lhs3rhsSf5value_Sf_SftSfc8pullbacktt1_u5FZSf_U6SfcfU_S2fTf1ncc_n : $@convention(thin) (Float, Float, Float) -> RealPropertyWrappers.TangentVector {
